...
class PathPlan(object):
    ...
    def goal_cb(self, msg):
        ...
        if True: #self.last_end_point != self.end_point:
            if self.algorithm=="RRT":
                self.RRTdone=False
                self.rrt_algorithm(self.start_point,self.end_point)
            else:
    ...
    def plan_path(self, start_point, end_point, map):
        ...
        if start_point != None and end_point != None and self.map_acquired and self.BFSdone==False:
            # self.astar_starttime=(rospy.Time.now())
            self.astar_starttime=time.clock()
            ...
            # self.astar_endtime=(rospy.Time.now())
            self.astar_endtime=time.clock()

            
            # print("Astar: ",self.astar_endtime.secs-self.astar_starttime.secs)
            ...
            # print("Astar: ",self.astar_endtime.secs-self.astar_starttime.secs)
            print("Astar: ",self.astar_endtime-self.astar_starttime)
            
            print("start: ", start_coordinate)
            
            print("end: ", end_coordinate)
	...
	if start_point != None and end_point != None and self.map_acquired and self.RRTdone==False:
            # self.rrt_starttime=(rospy.Time.now())
            self.rrt_starttime=(time.clock())
            # marker_end=Marker()
    ...
    def RRT_path(self,tree,final_leaf,start_leaf,endpoint):
        ...
        path.reverse()
        # self.rrt_endtime=(rospy.Time.now())
        self.rrt_endtime=time.clock()
        # print("enddimteRRT: ", self.rrt_endtime[0])
      
        # print("RRT: ",self.rrt_endtime.secs-self.rrt_starttime.secs)
        ...
        self.trajectory.publish_viz()
        # print("RRT: ",self.rrt_endtime.secs-self.rrt_starttime.secs)
        print("RRT: ",self.rrt_endtime-self.rrt_starttime)
        
        
        
        # self.plan_path(start_leaf,endpoint,self.map)
